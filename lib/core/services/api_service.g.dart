...
class _ApiService implements ApiService {
  ...
  @override
  Future<MealDetailResponse> getMealById(id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'i': id};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MealDetailResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = MealDetailResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<MealDetailResponse> searchMealByName(search) async {
    const _extra = <String, dynamic>{};
